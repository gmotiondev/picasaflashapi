...
import view.layout.OGrid;
import view.layout.MathUtils;

class view.layout.GridLayout extends LayoutManager
{
	private var __hGap:Number = 2;
	private var __vGap:Number = 2;
