	...
	implements IXMLToObjectDeserializer
{
	...
	private var _owner : XMLToObject;
	
	private function AbstractXMLToObjectDeserializer() 
	{
	...
	{
		PixlibDebug.FATAL( "You must implement " + this + ".deserialize virtual method before using it." );
	}
