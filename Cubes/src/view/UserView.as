...
import view.object.AlbumThumb;

/**
 * @author Michal Gron (michal.gron@gmail.com)
 */
class view.UserView extends MovieClipHelper implements ILibListener
{
	public var container :MovieClip;
	public var scene : MovieScene3D;
	public var camera : Camera3D;
	public var radius : Number = 3500;
	public var grid : OGrid;

	private var pos : Number = 0;
	private var open : Boolean = false;

	public function UserView(name : String, mc : MovieClip)
	{
		super(name, mc);
	...
	public function onLoadInit(evt : LibEvent) : Void
	{
		...
		var tXYZ : Object = {
			x : (tPos.x * radius / grid.getArea()),
			y : (tPos.y * radius / grid.getArea()),
			z : 100
			};
		...
		var tThumb : AlbumThumb = new AlbumThumb(tMaterial, tImage.width, tImage.height);
