	...
	extends GraphicLib
{
	...
	private static var _bIS_ROOT_INITIALIZED : Boolean = false;
	...
	{
		if (!OrphanGraphicLib._bIS_ROOT_INITIALIZED) setRootTarget();
	 ...
	 * static methods
	 */
	public static function get ROOT_KEY() : String
	{
		return _sROOTKEY;
	}
	
	public static function get IS_ROOT_INITIALIZED() : Boolean
	{
		return _bIS_ROOT_INITIALIZED;
	}
	...
	{
		if (OrphanGraphicLib._bIS_ROOT_INITIALIZED)
		{
		...
		} else
		{
			...
			OrphanGraphicLib._bIS_ROOT_INITIALIZED = true;
		}
	}
