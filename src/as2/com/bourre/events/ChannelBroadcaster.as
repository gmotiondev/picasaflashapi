...
class com.bourre.events.ChannelBroadcaster 
{
	...
	public function getChannelDispatcher( oChannel : String, owner ) : EventBroadcaster
	{
		if ( hasChannelDispatcher( oChannel ) )
		{
	...
	public function dispatchEvent( o : Object, channel : String ) : Void
	{
		var e : ChannelDynBasicEvent = new ChannelDynBasicEvent( o["type"], o["target"], o["channel"] );
		for ( var p : String in o ) if ( o[p] != "type" && o[p] != "target" && o[p] != "channel" ) e[p] = o[p];
		getChannelDispatcher( channel ).broadcastEvent( e );
	}
