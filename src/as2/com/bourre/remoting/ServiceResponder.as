...
class com.bourre.remoting.ServiceResponder 
{
	...
	public function onResult( rawResult ) : Void 
	{
		...
		invokeOnResult( buildResultEvent( rawResult ) );
	}
	
	public function invokeOnResult( e : BasicResultEvent ) : Void
	{
	...
	public function onStatus( rawFault : Object ) : Void 
	{
		...
		*/
		...
		invokeOnFault( new BasicFaultEvent( ServiceResponder.onFaultEVENT, 
											rawFault.code,
											rawFault.line,
											rawFault.level,
											rawFault.details, 
	...
	public function invokeOnFault( e : BasicFaultEvent ) : Void
	{
